# Zeichnen einer Linie nach Prozedur Simpel DDA (W.D. Fellner)
# DDA = Digital Differential Analyzer - die Koordinaten eines Punktes werden aus den Koordinaten des vorgehenden Punktes berechnet
# Erstellt: 26/09/20
