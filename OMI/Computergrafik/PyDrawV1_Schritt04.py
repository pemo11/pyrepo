...
# Erstellt: 06/10/20
# Schritt 4: Linien per Maus zeichnen
...
class Window(Frame):
    ...
    def stopDraw(self, event):
        ...
        currentX, currentY, currentX1Old, currentXOld = (0,0,0,0)
        drawMode = False
    ...
    def drawLine(self, event):
        ...
        if drawMode and currentXOld != 0:
            self.cavDraw.create_line(currentXOld, currentYOld, currentX1Old, currentY1Old,fill="white")
        currentX1 = event.x
        currentY1 = event.y
        self.cavDraw.create_line(currentX, currentY, currentX1, currentY1,fill="#0000ff")
